    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)){
                ...
                System.out.println("sadsad : "+jsonArray);
                System.out.println("the request: "+requestMap.get("productDetails"));
                System.out.println("leangth is: "+jsonArray.length());
